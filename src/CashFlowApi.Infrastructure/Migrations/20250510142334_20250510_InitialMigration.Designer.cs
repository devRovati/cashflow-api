...
namespace CashFlowApi.Infrastructure.Migrations
{
    ...
    [Migration("20250510142334_20250510_InitialMigration")]
    partial class _20250510_InitialMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CashFlowApi.Domain.Entities.CategoryEntity", b =>
                {
                    b.HasOne("CashFlowApi.Domain.Entities.CategoryEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CashFlowApi.Domain.Entities.TransactionEntity", b =>
                {
                    b.HasOne("CashFlowApi.Domain.Entities.TransactionEntity", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
